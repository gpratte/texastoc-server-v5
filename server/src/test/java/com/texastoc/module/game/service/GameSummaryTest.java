...
public class GameSummaryTest {
  ...
  public void testGameSummary() throws IOException {
    ...
    expecteBody = expecteBody.replaceAll("\\s", "");
    actualBody = actualBody.replaceAll("\\s", "");
